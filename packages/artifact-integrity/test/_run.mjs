...
//     anything but a literal. This package shipped with the quoted-glob
//     spelling and CI proved the point on the node the workflows pin: `Could
//     not find '.../test/*.test.mjs'`, from a directory holding six test files.
//     Enumerating explicit file paths is the one form every version has always
//     accepted, so the question does not arise.
 ...
 * and cross-examine.test.mjs landed, and to 9 on 2026-08-24 with
 * source-map-regions.test.mjs. Raise it when test files are added. */
const TEST_FILE_FLOOR = 9;
