...
/*
 * Volatile-pointer memset that the compiler is not permitted to optimize
 * away as a "dead store" before a variable goes out of scope. Using
 * plain memset() here would let the key persist on the stack after return.
 */
