...
void hmac_sha256(const unsigned char key[32], const unsigned char *msg, size_t n,
                 unsigned char out[32]);

/*
 * Best-effort secure wipe: volatile pointer prevents the compiler from
 * eliding the memset as a dead store (C11 memset_s is not universally
 * available; explicit_bzero is platform-specific).
 */
