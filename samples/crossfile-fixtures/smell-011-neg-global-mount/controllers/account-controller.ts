...
import { addAccount, dropAccount, editAccount } from '../store';
...
export async function renameAccount(req: AuthedRequest, res: Response) {
  const renamed = await editAccount(req.params.id, { displayName: req.body.displayName });
